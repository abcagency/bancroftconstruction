...
function re_theme_add_custom_box() 
{
	global $themename;
    add_meta_box( 
        "page-custom-options",
        __("Options", 'renovate'),
        "re_theme_inner_custom_box",
        "page",
		"normal",
		"core"
    );
	add_meta_box( 
        "options",
        __("Options", 'renovate'),
        "re_theme_inner_custom_box_post",
        "post",
		"normal",
		"core"
    );
}
add_action("add_meta_boxes", "re_theme_add_custom_box");
//backwards compatible (before WP 3.0)
//add_action("admin_init", "theme_add_custom_box", 1);

// Prints the box content
function re_theme_inner_custom_box($post)
{
	global $themename;
...
function re_theme_inner_custom_box_post($post)
{
	global $themename;
	//Use nonce for verification
	wp_nonce_field(plugin_basename( __FILE__ ), $themename . "_noncename");
