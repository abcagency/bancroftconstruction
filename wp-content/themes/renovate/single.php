...
<div class="theme-page padding-bottom-66">
			...
			<div class="vc_row wpb_row vc_inner">
				<div class="page-header-left">
					...
					<h1><?php if(count($post_template_page_array) && isset($post_template_page))
						{
							echo '<a href="' . get_permalink($post_template_page->ID) . '" title="' . esc_attr__("BLOG", 'renovate') . '">' . __("BLOG", 'renovate') . '</a>';
						}
						else
	...
	<div class="clearfix">
		...
		else
		{
			...
			echo do_shortcode(apply_filters('the_content', '<div class="vc_row wpb_row vc_row-fluid margin-top-70"><div class="vc_col-sm-12 wpb_column vc_column_container">[single_post show_post_tags="1"]</div></div>'));
		}
		?>
	</div>
</div>
