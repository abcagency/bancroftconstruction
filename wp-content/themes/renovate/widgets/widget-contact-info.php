...
{
	/** constructor */
    function re_contact_info_widget() 
	{
    ...
    function widget($args, $instance) 
	{
		...
		echo $before_widget;
		echo '<div class="contact-details-box' . ($icon!="" && $icon!="none" ? ' sl-small-' . $icon : '') . '">';
		if($title) 
		{
...
//register widget
add_action('widgets_init', create_function('', 'return register_widget("re_contact_info_widget");'));
?>