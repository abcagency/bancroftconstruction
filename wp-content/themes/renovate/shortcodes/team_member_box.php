...
function re_theme_team_member_box_vc_init()
{
	$params = array(
		array(
			"type" => "attach_image",
			"class" => "",
			"heading" => __("Alternative featured image", 'ql_team'),
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Header link", 'ql_team'),
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Header border", 'ql_team'),
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Featured image link", 'ql_team'),
