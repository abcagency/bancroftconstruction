		...
		?>
			...
			<div class="<?php echo strtolower($remove_come);?> <?php echo $ts_Layout_Cls;?>">
				<div class="wpsm_testimonial">
					...
					<?php if($ts_display_name=="yes"){?><span class="wpsm_testimonial-title"><?php echo $cs_name;?></span><?php }?>
					<?php if($ts_display_position=="yes"){?><span class="wpsm_testimonial-desi"><?php echo "-".$cs_posi;?></span><?php }?>

					<?php if($ts_display_website=="yes"){?>
					<div class="wpsm_testimonial-webname"><a target="_blank" href="<?php echo $cs_website;?>"><?php echo $cs_webname;?></a></div><?php }?>
...
else
{
		...
		?>
			<div class="<?php echo $ts_Layout_Cls;?>">
				<div class="wpsm_testimonial" style="text-align:center;">
					<?php if($ts_display_image=="yes"){?>
					<div class="wpsm_pic">
						<img src="<?php echo $img_url;?>" alt=""/>
					</div>
