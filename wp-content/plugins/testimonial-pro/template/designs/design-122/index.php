    ...
    foreach($All_data as $single_data)
        ...
        ?>
            <?php
                ...
                ?>
            <div class="item <?php echo strtolower($remove_come);?> <?php echo $ts_Layout_Cls;?>">
               <div class="row">
    <?php if($ts_display_image=="yes"){?>
   <div class="col-sm-6 col-xs-6 no-padding testi-img-block">
        <img class="authimg"  src="<?php echo $cs_photo;?>" >
    ...
    <div class="col-sm-6 col-xs-6">
        ...
        <span class="designation"> - <?php echo $cs_posi;?></span>
        <?php }?>
...
if($templates_presets=="grid"){$grid_clear_both= "<div style='clear:both'></div>";}
?>
<div class="item <?php echo $ts_Layout_Cls;?>">
 <div class="row">
    <?php if($ts_display_image=="yes"){?>
   <div class="col-sm-6 col-xs-6 no-padding testi-img-block">
        <img class="authimg"  src="<?php echo $cs_photo;?>" >
