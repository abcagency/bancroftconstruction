        ...
        ?>
            ...
            <div class="<?php echo strtolower($remove_come);?> <?php echo $ts_Layout_Cls;?>">
                <div class="wpsm_testimonial">
                    <div class="wpsm_content">
                        <?php if($ts_display_content=="yes"){?>
                        <p class="wpsm_description">
                            <?php echo $cs_desc;?>
                        </p><?php }?>
                        
                        <div class="wpsm_testimonial-content">
                            ...
                            <h3 class="wpsm_testimonial-title"><?php echo $cs_name;?><?php }?>
                            
                            <?php if($ts_display_position=="yes"){?>
                            <small class="wpsm_testimonial-desi"><?php echo $cs_posi;?></small><?php }?>
                            
                            <?php if($ts_display_website=="yes"){?>
                            <a target="_blank" class="wpsm_testimonial-webname" href="<?php echo $cs_website;?>"><?php echo $cs_webname;?></a><?php }?>
                ...
                <div class="wpsm_testimonial">
                    <div class="wpsm_content">
                        ...
                        <div class="wpsm_testimonial-content">
                            ...
                            <?php if($ts_display_website=="yes"){?>
                            <a class="wpsm_testimonial-webname" target="_blank" href="<?php echo $cs_website;?>"><?php echo $cs_webname;?></a><?php }?>
