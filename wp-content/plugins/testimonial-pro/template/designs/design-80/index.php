...
<div class="testimonail-info">
    <?php if($ts_display_content=="yes"){?>    
<p class="para">"<?php echo $cs_desc;?>"
</p>
<?php }?>
<div class="testimonail-title-role">
    <?php if($ts_display_name=="yes"){?>
<h3 class="testimonail-title"><?php echo $cs_name;?></h3>
<?php }?>
<?php if($ts_display_position=="yes"){?>
            <span class="testimonail-role"><?php echo $cs_posi;?></span>
            <?php }?>
...
<?php }?>
    ...
    <div class="testimonail-image">
        <img src="<?php echo $img_url;?>" alt="person">
    </div>
    <?php }?>
</div>              
