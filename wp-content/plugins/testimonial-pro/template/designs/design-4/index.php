<div id="wpsm_testi_pro_testislier_<?php echo $post_id; ?>">
<div>
...
jQuery(document).ready(function(){
 var owl_testi = jQuery("#testimonial_slider<?php echo $post_id; ?>");
        ...
        jQuery('#wpsm_testi_pro_testislier_<?php echo $post_id; ?> .owl-dot').on("click", function () {
            owl_testi.trigger('to.owl.carousel', [jQuery(this).index(), 300]);
        });
        jQuery('#wpsm_testi_pro_testislier_<?php echo $post_id; ?> .owl-dot').on("hover", function () {
            owl_testi.trigger('to.owl.carousel', [jQuery(this).index(), 300]);
        });
jQuery('#wpsm_testi_pro_testislier_<?php echo $post_id; ?> .owl-dot').hover(function () {
    jQuery(this).click();
},
function () {
    owl_testi.trigger('to.owl.carousel', [jQuery(this).index(), 300]);
