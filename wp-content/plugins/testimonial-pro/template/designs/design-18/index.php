<?php
    ...
    <div class="img-wrapper">
        <div class="hexagon hexagon2">
            <div class="hexagon-in1">
                ...
                <div class="hexagon-in2" style="background-image: url(<?php echo $cs_photo;?>)"></div>
                <?php }?>
            </div>
        </div>
    </div>
    <div class="wrapper-content">
        <div class="profile">
           <?php if($ts_display_name=="yes"){?> <span class="name"><?php echo $cs_name;?></span><?php }?>
            <?php if($ts_display_position=="yes"){?><span class="position"><?php echo $cs_posi;?></span><?php }?>
        </div>
        ...
        <div class="wrapper-info">
            <?php if($ts_display_website=="yes"){?><div class="website"><a target="_blank" href="<?php echo $cs_website; ?>"><?php echo $cs_webname;?></a></div><?php }?>
            <?php if($ts_display_email=="yes"){?><div class="email"><?php echo $cs_email;?></div><?php }?>
