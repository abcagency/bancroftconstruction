			...
			<div class="<?php echo strtolower($remove_come);?> <?php echo $ts_Layout_Cls;?>">
				<div class="wpsm_testimonial">
					...
					<div class="wpsm_testimonial-review">
						...
						<p class="wpsm_testimonial-description">
							<?php echo $cs_desc;?>
						</p><?php }?> 
						
						<?php if($ts_display_name=="yes"){?>
						<h4 class="wpsm_testimonial-title">
							<?php echo $cs_name;?><?php }?>
							
							<?php if($ts_display_website=="yes"){?>
							&nbsp;-&nbsp; <small class="wpsm_testimonial-webname"><a target="_blank"  href="<?php echo $cs_website;?>"><?php echo $cs_webname;?></a></small></h4><?php }?> 
				...
				<div class="wpsm_testimonial">
					...
					<div class="wpsm_testimonial-review">
						...
						<h4 class="wpsm_testimonial-title">
							...
							<?php if($ts_display_position=="yes"){?>
							&nbsp;-&nbsp; <small class="wpsm_testimonial-desi"><?php echo $cs_posi;?></small></h4><?php }?> 
							
							<?php if($ts_display_website=="yes" ){?>
							<div class="wpsm_testimonial-desi"><a target="_blank" href="<?php echo $cs_website; ?>"><?php echo $cs_webname;?></a></div><?php }?> 
