<div class="testimonial_center<?php echo $post_id; ?>">
   <?php
    ...
    <div class="testimonial-grid text-center">
    	 <?php if($ts_display_image=="yes"){?>
			        <div class="t_thumb">
                        <img class="img-responsive img-circle" src="<?php echo $img_url;?>" alt="jpg">
                    </div><?php }?>
                    <div class="t_details">
                        ...
                        <h4><?php echo $cs_name;?></h4><?php }?>
                        <?php if($ts_display_position=="yes"){?>
                           <h6> <?php echo $cs_posi;?></h6> <?php }?>
                    </div>    
        ...
        jQuery(document).ready(function(){
        	jQuery('.testimonial_center<?php echo $post_id; ?>').slick({
            autoplay: true,
            autoplaySpeed: 2000,
            dots: true,
            centerMode: true,
