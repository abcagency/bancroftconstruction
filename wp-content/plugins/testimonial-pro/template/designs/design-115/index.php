...
error_reporting(0);
 if($templates_presets=="filter")
    ...
    <div class="content">
        <div class="user">
            <?php if($ts_display_name=="yes"){?><div class="name"><?php echo $cs_name;?></div><?php }?>
            <?php if($ts_display_position=="yes"){?><div class="jobtitle">(<?php echo $cs_posi;?>)</div><?php }?>
        ...
        <p class="description">
         ...
         <?php }?>
        <?php if($ts_display_email=="yes"){?><p class="author-email"><?php echo $cs_email;?></p><?php }?>
        <?php if($ts_display_website=="yes"){?><p class="author-website"><a target="_blank" href="<?php echo $cs_website; ?>"><?php echo $cs_webname;?></a>
</p><?php }?>
    </div>
</div>
             </div>
