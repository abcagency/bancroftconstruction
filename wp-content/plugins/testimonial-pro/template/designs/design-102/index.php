        ...
        ?>
            ...
            <div class="<?php echo strtolower($remove_come);?> <?php echo $ts_Layout_Cls;?>">
                <div class="wpsm_testimonial">
                    ...
                    <a target="_blank" class="wpsm_testimonial-webname" href="<?php echo $cs_website ;?>"><?php echo $cs_webname;?></a>
                    <?php }?>
        ...
        ?>
            <div class="<?php echo $ts_Layout_Cls;?>">
                <div class="wpsm_testimonial">
                    ...
                    <?php if($ts_display_website=="yes"){?>
                    <a class="wpsm_testimonial-webname" target="_blank" href="<?php echo $cs_website;?>"><?php echo $cs_webname;?></a>
                    <?php }?>
