<select name="font_family" id="font_family" class="standard-dropdown" onchange="get_font_group()"  style="width:100%" >
					...
					<optgroup label="Google Fonts">
						...
						<option value="Exo 2" <?php selected($font_family, 'Exo 2' ); ?>>Exo 2</option>
						...
						<option value="Source Sans Pro" <?php selected($font_family, 'Source Sans Pro' ); ?>>Source Sans Pro</option>
