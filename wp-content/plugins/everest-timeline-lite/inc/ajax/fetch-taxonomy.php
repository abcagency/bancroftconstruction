...
?>
<option value="select" <?php if ( isset( $et_option[ 'select_post_taxonomy' ] ) && $et_option[ 'select_post_taxonomy' ] == 'select' ) echo 'selected=="selected"'; ?>><?php echo _e( 'Select', ETLAK_TD ); ?></option>
