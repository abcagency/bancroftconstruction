...
#wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .table-head.wpsm-table-row .wpsm-table-cell{
...
#wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .wpsm-table .wpsm-table-cell {
  border-bottom: 1px solid #eee;
}
#wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .wpsm-table .table-name {
  font-size:<?php echo $tm_name_size;?>px;
  font-family:'<?php echo $font_family;?>';
  color:<?php echo $tm_name_clr;?>;
  font-weight:<?php echo $tm_name_weight ;?>;
}
#wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .wpsm-table .table-designation {
   font-size:<?php echo $tm_position_size ;?>px;
  font-family:'<?php echo $font_family;?>';
  color:<?php echo $tm_position_clr;?>;
  font-weight:<?php echo $tm_position_weight ;?>;
}
#wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .wpsm-table .table-description {
...
@media screen and (max-width: 768px){
  ...
  #wpsm_team_pro_row_<?php echo $post_id; ?> .wpsm-table {
   ...
   #wpsm_team_pro_row_<?php echo $post_id; ?> .table-1 .wpsm-table-row {
    padding-bottom: 20px;
    border-bottom: 1px solid #eee;
    margin-bottom: 20px;
   }
