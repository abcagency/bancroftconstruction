...
{ 
?>
    <img src="<?php echo $cs_photo;?>" alt="team Image">
    <?php
}
?>
    ...
    <div class="team-info">
        <div class="team-detail">
         ...
         <?php 
                ...
                {
                ?>
                <a href="#p<?php echo $post_id; ?><?php echo $inc;?>" class="team-name2 wpsm-popup-trigger<?php echo $post_id; ?>">  
                    <?php echo $cs_name;?></a>
                <?php
                }
                ?>
                ...
                {
                ?>
                <a href="#" class="team-name2 case-tab<?php echo $post_id; ?>" data-tab="case<?php echo $post_id; ?><?php echo $inc;?>">
                <?php echo $cs_name;?></a>
                <?php
                }
                ?>
                ...
                {
                ?>
                <span class="team-name2"><?php echo $cs_name;?></span>
                <?php
                }
                ?> 
            </h3>
            ...
            <?php if ($tm_display_position == "yes")
            { ?>
            <h4 class="team-position2"><?php echo $cs_posi;?></h4>
            <?php
            }
            ?>
            ...
            <p><?php echo substr($cs_desc,0,150); ?></p>
            </div>
            <?php
            }
            ?>
