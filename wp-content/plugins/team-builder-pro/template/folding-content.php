<!--below code will be run if user select folding effect-->
<?php 
if($tm_pop_style=="folding")
{
?>
<div class="team-deatil-popup<?php echo $post_id; ?>">
<div class="popup-wrap">
    <a href="#" class="wpsm-popup-close"></a>
...
?>
<div class="wpsm-team-popup" id="case<?php echo $post_id; ?><?php echo $inc;?>">
    <div class="row">
