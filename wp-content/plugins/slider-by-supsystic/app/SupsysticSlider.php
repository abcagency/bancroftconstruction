...
class SupsysticSlider
{
    ...
    public function __construct()
    {
        ...
        if (!class_exists('Twig_SupTwg_Autoloader', false)) {
            require dirname(dirname(__FILE__)) . '/vendor/Twig/Autoloader.php';
            Twig_SupTwg_Autoloader::register();
        }
        ...
        $environment = new Rsc_Environment('ssl', '1.7.50', $pluginPath);
    ...
    protected function initFilesystem()
    {
        $directories = array(
            ...
            'Twig_SupTwg_cache' => '/supsystic-slider/cache/twig',
