 ...
 */
class SupsysticSlider_Slider_Twig_SupTwg_Attachment extends Twig_SupTwg_Extension
{
    ...
    {
        return 'SupsysticSlider_Slider_Twig_SupTwg_Attachment';
    }
    ...
    {
        return array(
            new Twig_SupTwg_SimpleFilter('image_size', array(
                $this,
                'getImageSizeFilter'
            )),
            new Twig_SupTwg_SimpleFilter('attachment_size', array(
                $this->helper,
                'getSize'
            )),
        );
