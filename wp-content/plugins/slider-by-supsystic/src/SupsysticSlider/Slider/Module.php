...
class SupsysticSlider_Slider_Module extends SupsysticSlider_Core_BaseModule
{
	...
	public function addTwigFunctions() {
      ...
      $twig = $this->getTwig();
		...
		$twig->addFunction(
		       new Twig_SupTwg_SimpleFunction('unserialize_twig', array($this, 'unserialize'))
		);
		$twig->addFunction(
		       new Twig_SupTwg_SimpleFunction('all_posts', array($this, 'get_posts'))
		);
      $twig->addFunction(
		       new Twig_SupTwg_SimpleFunction('all_pages', array($this, 'get_pages'))
      );
      $twig->addFunction(
         new Twig_SupTwg_SimpleFunction('all_categories', array($this, 'get_categories'))
      );
      $twig->addFunction(
         new Twig_SupTwg_SimpleFunction('get_image_src', array($this, 'wp_get_attachment_image_src'))
      );
    ...
    {
        $twig = $this->getEnvironment()->getTwig();
        $twig->addExtension(new SupsysticSlider_Slider_Twig_SupTwg_Attachment());
    }
